...
class ConnectionServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Get = channel.unary_unary(
                ...
                response_deserializer=connection__pb2.ConnectionData.FromString,
                )
...
def add_ConnectionServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Get': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=connection__pb2.ConnectionData.SerializeToString,
            ),
    }
...
class ConnectionService(object):
    ...
    def Get(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/ConnectionService/Get',
            ...
            connection__pb2.ConnectionData.FromString,
